...
function onMessageArrived(message) {
  ...
  // if (values[0] == 'stop=1' && values[1] == 'speed=0') {
  ...
  values.forEach(item => {
      ...
      // const scheduleCheckbox = document.getElementById('ScheduleMode');
      ...
      if (keyValue.length === 2) {
        ...
        const values = parseFloat(keyValue[1].trim());
          ...
          // if (key === 'speed' && manualModeCheckbox.checked) {
          //     document.getElementById('box_Mspeed').value = values;
          // }
          // if (key === 'speed'&& scheduleModeCheckbox.checked) {
          //   document.getElementById('box_Sspeed').value = values;
          // }
...
// function Manual(){
//   document.getElementById('box_Sspeed').value = '';
//   document.getElementById('dateInputON').value = '';
//   document.getElementById('timeInputON').value = '';
//   document.getElementById('dateInputOFF').value = '';
//   document.getElementById('timeInputOFF').value = '';
//   console.log('Hello!');
// }
// function Schedual(){
//   document.getElementById('box_Mspeed').value = '';
//   console.log('Hi!');
// }
